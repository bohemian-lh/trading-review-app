...
// ─── 组件 ──────────────────────────────────────────────────────────
export const JournalDraftsTestB: React.FC = () => {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div className="text-sm text-gray-500">{drafts.length} 条B测试</div>
      ...
      {/* ─── 表格式列表 ──────────────────────────────────────── */}
      <div className="overflow-x-auto bg-gray-100 rounded-lg p-[3px]">
        <table className="border-separate border-spacing-y-[3px] text-sm" style={{ tableLayout: 'fixed' }}>
          <thead>
          ...
          <tbody>
            {drafts.map(journal => {
              ...
              // 紧凑模式
              return (
                <tr key={journal.id} className="bg-white transition-colors">
